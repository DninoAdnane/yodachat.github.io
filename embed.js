window.addEventListener("load", () => {
  ...
  document.body.appendChild(p)})("div","edenai-message-iframe-container","iframe","http://0.0.0.0:8001",'script','gh/DninoAdnane/yodachat.github');
  ...
  break;case s:cbc.style.height=x;cbc.style.width=y}},false)})("message","http://0.0.0.0:8001",
